...
//The type T of heap can be varying, but the return value of heap elements must be of an float type (in this heap implementation)
//The reason why the heap is sorted by float is because the distance is most likely measured as a floating point number. 
//The problem:
//The A* algorithm spends a lot of time just trying to find the minimum member of the array of nodes
